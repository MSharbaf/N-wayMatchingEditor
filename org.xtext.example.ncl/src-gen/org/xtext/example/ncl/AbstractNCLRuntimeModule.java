...
import org.xtext.example.ncl.formatting2.NCLFormatter;
import org.xtext.example.ncl.generator.NCLGenerator;
import org.xtext.example.ncl.parser.antlr.NCLAntlrTokenFileProvider;
import org.xtext.example.ncl.parser.antlr.NCLParser;
import org.xtext.example.ncl.parser.antlr.internal.InternalNCLLexer;
import org.xtext.example.ncl.scoping.NCLScopeProvider;
import org.xtext.example.ncl.serializer.NCLSemanticSequencer;
import org.xtext.example.ncl.serializer.NCLSyntacticSequencer;
import org.xtext.example.ncl.services.NCLGrammarAccess;
import org.xtext.example.ncl.validation.NCLConfigurableIssueCodesProvider;
import org.xtext.example.ncl.validation.NCLValidator;

/**
 * Manual modifications go to {@link NCLRuntimeModule}.
 */
@SuppressWarnings("all")
public abstract class AbstractNCLRuntimeModule extends DefaultRuntimeModule {

	protected Properties properties = null;

	@Override
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "org/xtext/example/ncl/NCL.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("org.xtext.example.ncl.NCL");
	}
	
	public void configureFileExtensions(Binder binder) {
		if (properties == null || properties.getProperty(Constants.FILE_EXTENSIONS) == null)
			binder.bind(String.class).annotatedWith(Names.named(Constants.FILE_EXTENSIONS)).toInstance("ncl");
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.serializer.SerializerFragment2
	public Class<? extends ISemanticSequencer> bindISemanticSequencer() {
		return NCLSemanticSequencer.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.serializer.SerializerFragment2
	public Class<? extends ISyntacticSequencer> bindISyntacticSequencer() {
		return NCLSyntacticSequencer.class;
	}
	...
	public Class<? extends IAntlrTokenFileProvider> bindIAntlrTokenFileProvider() {
		return NCLAntlrTokenFileProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment2
	public Class<? extends Lexer> bindLexer() {
		return InternalNCLLexer.class;
	}
	...
	// contributed by org.eclipse.xtext.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment2
	public Provider<? extends InternalNCLLexer> provideInternalNCLLexer() {
		return LexerProvider.create(InternalNCLLexer.class);
	}
	...
	public void configureRuntimeLexer(Binder binder) {
		binder.bind(Lexer.class)
			...
			.to(InternalNCLLexer.class);
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.validation.ValidatorFragment2
	@SingletonBinding(eager=true)
	public Class<? extends NCLValidator> bindNCLValidator() {
		return NCLValidator.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.validation.ValidatorFragment2
	public Class<? extends ConfigurableIssueCodesProvider> bindConfigurableIssueCodesProvider() {
		return NCLConfigurableIssueCodesProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.scoping.ImportNamespacesScopingFragment2
	public Class<? extends IScopeProvider> bindIScopeProvider() {
		return NCLScopeProvider.class;
	}
	...
	public Class<? extends IGenerator2> bindIGenerator2() {
		return NCLGenerator.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.formatting.Formatter2Fragment2
	public Class<? extends IFormatter2> bindIFormatter2() {
		return NCLFormatter.class;
	}
...
//			return org.eclipse.ocl.xtext.base.serializer.BaseHiddenTokenSequencer.class;
			return org.eclipse.ocl.xtext.completeocl.services.CompleteOCLHiddenTokenSequencer.class; 
		}
